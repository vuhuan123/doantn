...
function ActiveCard() {
  ...
  const onUpdateCardMember = (incomingMemberInfor) => {
    callApiUpdateCard({incomingMemberInfor})
  }
  return (
    <Modal
      disableScrollLock
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={9}>
            <Box sx={{ mb: 3 }}>
              ...
              <CardUserGroup cardMemberIds = {activeCard?.memberIds} onUpdateCardMember = {onUpdateCardMember}/>
            </Box>
