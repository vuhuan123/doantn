...
function BoardContent({ board, createNewColumn, createNewCard, moveColumns, moveCardInTheSameColumn, moveCardToDifferentColumn, deleteColumnDetail }) {
    ...
    useEffect(() => {
        ...
        setOderedColumnsState(board?.columns)
    }, [board])
    ...
    const moveCardBetwwenDifferentColumns = (
        ...
        setOderedColumnsState(prev => {
            ...
            // neu func dc goi tu handleDragEnd nghia la da keo tha xong
    ...
    const handleDragEnd = (event) => {
        ...
        if (activeDragItemType === ACTIVE_DRAG_ITEM_TYPE.CARD) {
            ...
            if (oldColumnWhenDraggingCard._id !== overColumn._id) {
                ...
                // Goi API de cap nhat lai vi tri card trong DB
                moveCardInTheSameColumn(dndOderedCards, dndOrderedCardsIds,oldColumnWhenDraggingCard._id)
    ...
    return (
        ...
        >
            <Box sx={{
                ...
                <ListColumms columns={oderedColumnsState} createNewColumn = {createNewColumn} createNewCard={createNewCard} deleteColumnDetail={deleteColumnDetail} />
